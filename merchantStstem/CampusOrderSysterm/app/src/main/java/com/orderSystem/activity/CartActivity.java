...
import com.orderSystem.adapter.LeftMenuAdapter;
import com.orderSystem.adapter.RightDishAdapter;
import com.orderSystem.imp.ShopCartImp;
import com.orderSystem.model.Dish;
import com.orderSystem.model.DishMenu;
import com.orderSystem.model.ShopCart;
import com.orderSystem.widget.FakeAddImageView;
import com.orderSystem.widget.PointFTypeEvaluator;
import com.orderSystem.widget.ShopCartDialog;
...
public class CartActivity extends AppCompatActivity implements LeftMenuAdapter.onItemSelectedListener,ShopCartImp,ShopCartDialog.ShopCartDialogImp {
    ...
    private FrameLayout gotoPayLayout;
...
//        这里调用登录
    ...
    private void initView(){
        mainLayout = (RelativeLayout)findViewById(R.id.food_list);
...
//        fakeAddImageView = (FakeAddImageView)findViewById(R.id.right_dish_fake_add);
        ...
        gotoPayLayout = (FrameLayout) findViewById(R.id.goto_pay);
...
//                            Log.e(TAG, "onScrolled: "+headerLayout.getTranslationY()+"   "+headerLayout.getBottom()+"  -  "+headerLayout.getMeasuredHeight() );
        ...
        gotoPayLayout.setOnClickListener(new View.OnClickListener() {
...
//            这里进入NFC的view
            ...
            public void onClick(View view) {
                ...
                //用putString的方法保存数据
                editor.putFloat("totalPrice", new Float(shopCart.getShoppingTotalPrice()));
                //提交当前数据
                editor.commit();
                Intent intent = new Intent(CartActivity.this, NFCActivity.class);
                startActivity(intent);
            }
        });
    }
...
//        DishMenu menu1 = new DishMenu("",dishs4);
